...
import { Users, Mail, Lock, User, ArrowRight, Sparkles, Eye, EyeOff, Shield, BookOpen, Brain, Zap, Loader2 } from 'lucide-react';
import { z } from 'zod';
          ...
          <Card variant="elevated" className="border-0 shadow-medium backdrop-blur-sm bg-card/95">
            ...
            <CardContent className="pt-6">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full animate-fade-up delay-450"
                size="lg"
